...
HEADERS = structures.h sets.h memory.h sequence.h tree.h terminator.h arguments.h selection.h
OBJS = main.o sets.o memory.o sequence.o tree.o terminator.o arguments.o selection.o
TARGET = hudson
